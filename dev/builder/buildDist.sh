...
FILES=( "/ckeditor.js" "/styles.js" "/contents.css" "/skins/mathhire/skin.js" "/skins/mathhire/dialog.css" "/skins/mathhire/editor.css" "/lang/en.js" "/plugins/magicline/images" )
for FILE in "${FILES[@]}"
do
    mkdir -p `dirname $TARGET_DIR$FILE`
    cp -R $RELEASE_DIR$FILE $TARGET_DIR$FILE
done
